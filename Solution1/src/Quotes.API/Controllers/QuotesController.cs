...
public class QuotesController : ControllerBase
{
    ...
    public async Task<IActionResult> AddQuoteItem([FromRoute] int id, [FromBody] AddQuoteItemRequest request)
    {
    ...
    public async Task<IActionResult> SubmitQuote([FromRoute] int id)
    {
    ...
    [HttpPut("{id}/review")]
    public async Task<IActionResult> ReviewQuote([FromRoute] int id)
    {
    ...
    [HttpPut("{id}/approval")]
    public async Task<IActionResult> ApproveQuote([FromRoute] int id)
    {
    ...
    [HttpPut("{id}/payment")]
    public async Task<IActionResult> PayQuote([FromRoute] int id)
    {
    ...
    public async Task<IActionResult> CompleteQuote([FromRoute] int id)
    {
